...
- Click a deck-list card image to inspect it at a larger high-resolution size, zoom it with pinch or `Command` + scroll, then click the same thumbnail again to close it
