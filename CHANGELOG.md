...
- Deck-list card preview popovers now render 40% larger with high-resolution art, support pinch or `Command` + scroll zooming, and close when you click the same thumbnail again.
